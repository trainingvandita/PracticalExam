    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(string id)
        {
            if (!string.IsNullOrEmpty(id))
            {
                ...
                TableManager TableManagerObj = new TableManager("MalavEmployeeDetails"); // 'person' is the name of the table  
        ...
        public ActionResult Index(string id, FormCollection formData, HttpPostedFileBase file)
        {
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                TableManager TableManagerObj = new TableManager("MalavEmployeeDetails");
                //BlobManager BlobManagerObj = new BlobManager("trainingblobcontainer");
